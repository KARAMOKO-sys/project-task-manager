 ...
 class TeamMembersRepository{
    ...
    public function findAll()
    {
        try{
            ...
            $stmt->execute();
            return $stmt->fetchAll(PDO::FETCH_CLASS, TeamMembers::class);
    ...
    public function findById($id)
    {
       try{
        ...
        $stmt->execute();
        return $stmt->fetchObject(TeamMembers::class);
       }catch(PDOException $e){
    ...
    public function save(TeamMembers $task)
    {
       try {
    ...
    public function update(TeamMembers $task)
    {
        try{
